...
import {formatPriceToJapaneseYen} from "../lib/utils"
        ...
        <nav className=" text-sm font-normal sm:font-medium">
          ...
          <div className=" flex gap-3">
            <span className=" text-sm text-lightGray line-through ">
              {formatPriceToJapaneseYen(products.oldPrice)}
            </span>
            <b className=" text-zinc-900 "> {formatPriceToJapaneseYen(products.price)} </b>
          </div>
        </nav>
